...
var _todo_api_util = __webpack_require__(91);

var APIUtil = _interopRequireWildcard(_todo_api_util);

var _error_actions = __webpack_require__(94);
...
var createTodo = exports.createTodo = function createTodo(todo) {
  return function (dispatch) {
    return APIUtil.createTodo(todo).then(function (response) {
...
var updateTodo = exports.updateTodo = function updateTodo(todo) {
  return function (dispatch) {
    return APIUtil.updateTodo(todo).then(function (response) {
...
var deleteTodo = exports.deleteTodo = function deleteTodo(todo) {
  return function (dispatch) {
    return APIUtil.deleteTodo(todo).then(function (response) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_Subscription__ = __webpack_require__(71);
...
var stepsByToDoId = function stepsByToDoId(state, todoId) {
  var keys = Object.keys(state.steps);
  var arr = [];
...
var _root = __webpack_require__(65);
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    window.store = store;
    window.updateTodo = _todo_api_util.updateTodo;
...
*/
var aa=__webpack_require__(1),m=__webpack_require__(16),A=__webpack_require__(3),B=__webpack_require__(2),ca=__webpack_require__(17),da=__webpack_require__(18),ea=__webpack_require__(19),ha=__webpack_require__(20),ia=__webpack_require__(21),C=__webpack_require__(6);
...
var _root_reducer = __webpack_require__(61);

var _root_reducer2 = _interopRequireDefault(_root_reducer);

var _thunk = __webpack_require__(92);
...
var _todos_reducer = __webpack_require__(62);

var _todos_reducer2 = _interopRequireDefault(_todos_reducer);

var _steps_reducer = __webpack_require__(63);

var _steps_reducer2 = _interopRequireDefault(_steps_reducer);

var _error_reducer = __webpack_require__(93);
...
var _todo_action = __webpack_require__(13);
...
var _step_actions = __webpack_require__(14);

function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

var stepsReducer = function stepsReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { 1: { id: 1, title: 'step!', todo_id: 2 } };
  var action = arguments[1];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_shallowEqual__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mapDispatchToProps__ = __webpack_require__(74);
...
var _todo_list_container = __webpack_require__(80);
...
var _todo_list = __webpack_require__(81);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    createTodo: function createTodo(todo) {
      return dispatch((0, _todo_action.createTodo)(todo));
    },
    receiveTodo: function receiveTodo(todo) {
      return dispatch((0, _todo_action.receiveTodo)(todo));
    },
    removeTodo: function removeTodo(todo) {
      return dispatch((0, _todo_action.removeTodo)(todo));
    },
    fetchTodos: function fetchTodos() {
      return dispatch((0, _todo_action.fetchTodos)());
    },
    updateTodo: function updateTodo(todo) {
      return dispatch((0, _todo_action.updateTodo)(todo));
    }
  };
};
...
var _todo_list_item = __webpack_require__(82);

var _todo_list_item2 = _interopRequireDefault(_todo_list_item);

var _todo_form = __webpack_require__(90);
...
var _todo_detail_container = __webpack_require__(83);

var _todo_detail_container2 = _interopRequireDefault(_todo_detail_container);
...
var TodoListItem = function (_React$Component) {
  ...
  _createClass(TodoListItem, [{
    ...
    value: function updateTodo(todo) {
      todo.done = !todo.done;
      this.props.updateTodo({ id: todo.id, todo: todo });
    }
  }, {
    key: 'toggleDetails',
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { onClick: function onClick() {
              return _this2.updateTodo(_this2.todo);
            } },
          this.todo.done ? 'Undo' : 'Done'
        ),
        _react2.default.createElement(_todo_detail_container2.default, { todo: this.todo, details: this.state.details }),
...
var _todo_detail_view = __webpack_require__(84);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    deleteTodo: function deleteTodo(todo) {
      return dispatch((0, _todo_action.deleteTodo)(todo));
    }
  };
};
...
var _step_list_container = __webpack_require__(85);
...
exports.default = function (_ref) {
  var deleteTodo = _ref.deleteTodo,
      ...
      stepsById = _ref.stepsById;
  return _react2.default.createElement(
    'div',
    { style: { "display": details ? "block" : "none" } },
    todo.body,
    _react2.default.createElement(_step_list_container2.default, { todo: todo }),
    _react2.default.createElement(
      'button',
      { onClick: function onClick() {
...
var _step_list = __webpack_require__(86);
...
var mapStateToProps = function mapStateToProps(state) {
  return {
    stepsById: function stepsById(stepID) {
      return (0, _selectors.stepsByToDoId)(state, stepID);
    }
  };
};
...
var _step_list_item_container = __webpack_require__(87);

var _step_list_item_container2 = _interopRequireDefault(_step_list_item_container);

var _step_form = __webpack_require__(89);
...
exports.default = function (_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'ul',
      null,
      stepsById(todo.id).map(function (step) {
        return _react2.default.createElement(_step_list_item_container2.default, { step: step, key: step.id });
      })
    ),
    _react2.default.createElement(_step_form2.default, { todo: todo, receiveStep: receiveStep })
  );
};
...
var _step_list_item = __webpack_require__(88);
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_step_list_item2.default);
...
var StepForm = function (_React$Component) {
  ...
  function StepForm(props) {
    ...
    _this.receiveStep = props.receiveStep;
    _this.receiveSteps = props.receiveSteps;
    _this.todo_id = props.todo.id;
  ...
  _createClass(StepForm, [{
    ...
    value: function handleSubmit() {
      ...
      return function (evt) {
        evt.preventDefault();
        _this2.receiveStep({ id: (0, _util2.default)(), title: _this2.state.title, body: _this2.state.body, done: false, todo_id: _this2.todo_id });
        _this2.setState({ body: "", title: "" });
      };
    }
  }, {
    key: 'render',
...
var TodoForm = function (_React$Component) {
  ...
  function TodoForm(props) {
    ...
    _this.createTodo = props.createTodo;
    _this.state = { title: "", body: "" };
    _this.handleInput = _this.handleInput.bind(_this);
    return _this;
  }
  ...
  _createClass(TodoForm, [{
    ...
    value: function handleSubmit() {
      ...
      return function (evt) {
        evt.preventDefault();
        _this2.createTodo({ todo: { id: (0, _util2.default)(), title: _this2.state.title, body: _this2.state.body, done: false } });
